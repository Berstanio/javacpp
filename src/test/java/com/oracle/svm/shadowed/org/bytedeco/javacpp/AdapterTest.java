...
import com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.SharedPtr;
import com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.StdBasicString;
...
import com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.StdU16String;
import com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.StdU32String;
import com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.StdVector;
import com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.StdWString;
import com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.UniquePtr;
...
public class AdapterTest {
    ...
    static native @StdString
	String testStdString(@StdString String str);
    static native @StdString BytePointer testStdString(@StdString BytePointer str);

    static native @StdWString
	CharPointer testStdWString(@StdWString CharPointer str);
    static native @StdWString @AsUtf16
	String testStdWString(@StdWString @AsUtf16 String str);
    ...
    static native @StdU16String
	CharPointer testStdU16String(@StdU16String CharPointer str);
    static native @StdU16String @AsUtf16 String testStdU16String(@StdU16String @AsUtf16 String str);
    static native @StdU32String
	IntPointer testStdU32String(@StdU32String IntPointer str);
    ...
    static native @Const
	@ByRef
	@StdString byte[] getConstStdString();
